...
const Contact = () => {
  ...
  useEffect(() => {
    document.title = "Contact with Zakaria"
  }, []);
              ...
              <li>
                <div className="media align-items-center"><span className="info-icon"></span>
                  <div className={classes.infoList}>
                    <h6 className="info-type">Name</h6><span className="info-value">Zakaria Sumon</span>
                  </div>
                </div>
              </li>
              <li>
                <div className="media align-items-center"><span className="info-icon"><i className="icon ion-md-map"></i></span>
                  <div className={classes.infoList}>
                    <h6 className="info-type">Location</h6><span className="info-value">Sunamganj, Bangladesh</span>
                  </div>
                </div>
              </li>
              <li>
                <div className="media align-items-center"><span className="info-icon"><i className="icon ion-md-call"></i></span>
                  <div className={classes.infoList}>
                    <h6 className="info-type">Call Me</h6><span className="info-value"><a href="tel:+8801780849889">+88 01757454532</a></span>
                  </div>
                </div>
              </li>
              <li>
                <div className="media align-items-center"><span className="info-icon"><i className="icon ion-md-send"></i></span>
                  <div className={classes.infoList}>
                    <h6 className="info-type">Email Me</h6><span className="info-value"><a href="mailto:cm.dpi15@gmail.com">zaknetsum@gmail.com</a></span>
                  </div>
                </div>
              </li>
            </ul>
